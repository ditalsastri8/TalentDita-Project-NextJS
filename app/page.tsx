...
export default function Home() {
  ...
  return (
    <main className="container mt-5 bg-slate-100 p-7">
      <div>
        <h2 className="scroll-m-14 text-2xl font-bold lg:text-5xl">Talent Class - NextJS</h2>
        <div>
          <h2> Berikut adalah Implementasi Class NextJS</h2>
        </div>
        <h2> Data Kucing </h2>
        ...
        <div className="flex flex-wrap gap-1">
          ...
          <ItemProduct name="Glosier" imgCat="https://i.pinimg.com/564x/e4/97/ac/e497ac6330db465a28a77422d1f074a4.jpg"/><Counter />
        </div>
        <h1> Data City</h1>
        <div className="flex flex-wrap gap-1">
